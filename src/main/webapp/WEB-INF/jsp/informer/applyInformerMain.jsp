...
/* 서브 메뉴 클릭 시 페이지 이동 함수 */

function changePage(url){
		
		if(url == 'select') { // 클릭 시 통신원 관리 화면으로 이동
			$.ajax
			(
				{
					type : "post" ,
					url : "/informer/informerMain.do",
					dataType : "html" ,
					cache : false ,
		...
		} else if(url == 'standard'){ // 클릭 시 app 가입 신청 화면으로 이동
			$.ajax
			(
				{
					type : "post" ,
					url : "/informer/applyInformerMain.do" ,
					dataType : "html" ,
					cache : false ,
					success:function(html){
						$('#contentWrap').html(html);
		...
		} else if(url == 'selectApp') {
			$.ajax
			(
				{
					type : "post" ,
					url : "/informer/appInformerMain.do" ,
					dataType : "html" ,
					cache : false ,
					success:function(html){
						$('#contentWrap').html(html);
