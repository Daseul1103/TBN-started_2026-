...
public class MileageController extends BaseController{
	...
	throws Exception {
		...
		// 26-07 : 개인정보 암호화 완료
		List<AwardVO> awardInformerList = mileageService.selectUserAwardList(paramVO);
	...
	public String exselDownload(Model model,@ModelAttribute("AwardVO") AwardVO paramVO) throws Exception {
		...
		// 26-07 : 개인정보 암호화 처리 완료
		List<RecordDto> awardInformerList = mileageService.getAwardInformerList2(paramVO);
	...
	public String exselDownloadUserList(Model model,@ModelAttribute("AwardVO") AwardVO paramVO) throws Exception {
		...
		// 26-07 : 개인정보 암호화 처리 완료
		List<RecordDto> awardInformerList = mileageService.selectUserAwardList2(paramVO);
	...
	public ModelAndView bestList (HttpServletRequest request, Model model,
		...
		// 목록 불러오기 1 - 통신원 아이디, 통신원 이름, 통신원 소속 등 기본 정보 가져오기
		// 26-07 : 개인정보 암호화 작업 완료
